...
export const TRAVEL_AUTHS: TravelAuth[] = [
  {
    ...
    status: "upcoming",
    statusNote: "Not yet required. The EU expects ETIAS to start in the last quarter of 2026, followed by a roughly six-month transitional grace period before it becomes mandatory. Until it launches you do NOT need it — but check the official source before travel, as dates have shifted before.",
    ...
    cost: "€20 per application — the European Commission confirmed this fee in July 2025, replacing the originally proposed €7. Applicants under 18 or over 70 are exempt from the fee. One payment covers the full validity period. Confirm on the official site before applying.",
