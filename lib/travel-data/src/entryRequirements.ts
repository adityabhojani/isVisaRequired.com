// Entry requirements beyond the visa itself: passport validity, onward ticket,
// proof of funds, insurance, vaccinations and pre-travel authorisations.
//
// This is the ONLY copy. Until 2026-09-21 the React app carried its own
// duplicate, and it had drifted onto wrong facts the server copy had already
// corrected: it told travellers ETIAS launched in 2025 at EUR 7 (it has not
// launched; the fee is EUR 20), that New Zealand's visitor levy is NZD 35 (it
// tripled to NZD 100 on 1 Oct 2024), and that NZ allows 3-9 months (it is 3 per
// visit, 6 on a UK passport, and never more than 6 in any 12). Both apps now
// import this file through @workspace/travel-data, so a correction lands on
// every page at once.
